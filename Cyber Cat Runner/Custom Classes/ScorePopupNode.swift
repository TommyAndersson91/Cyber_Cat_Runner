...
class ScorePopupNode: PopupNode {
    ...
    /*
    Initiering för att skapa poäng popup. Ska animeras om level klaras av och inte animeras ifrån level-vyn.
    ...
    /*
    Funktonen som används för att lägga till tomma eller fyllda stjärnor när man klarar en nivå
     empty är tomma sjärnor
    och star är fyllda
     zRotation används för att kunna rotera sprites.  I detta fallet stjärnorna.
    ...
    */
    ...
    func addCoins(count: Int) {
        ...
        coinLabel.zPosition = GameConstants.ZPositions.hudZ + 1
        addChild(coinLabel)
    }
